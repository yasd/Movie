			...
			<div>
				...
				<div class="row">
					<c:forEach items="${book1.list}" var="b1" >
						<div class="col-sm-6 col-md-3 wow fadeInLeft animated">
						<div class="thumbnail">
							<a href="${path}/list/book?bookid=${b.bookId}"><img src="../images/${b1.imgurl}" alt="通用的占位符缩略图"></a>
							<div class="caption">
								<h4>${b1.name}</h4>
			...
			<div>
				...
				<div class="row">
					<c:forEach items="${book2.list}" var="b2" >
						<div class="col-sm-6 col-md-3 wow fadeInLeft animated">
						<div class="thumbnail">
							<a href="${path}/list/book?bookid=${b.bookId}"><img src="../images/${b2.imgurl}" alt="通用的占位符缩略图"></a>
							<div class="caption">
								<h4>${b2.name}</h4>
