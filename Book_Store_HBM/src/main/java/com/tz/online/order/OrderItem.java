...
public class OrderItem implements Serializable {
	...
	public OrderItem(Long itemId, String book_isbn, String book_name, String book_author, int count, double allPrice,
			Order order) {
		super();
		this.itemId = itemId;
	...
	public OrderItem(String book_isbn, String book_name, String book_author, int count, double allPrice, Order order) {
		super();
		this.book_isbn = book_isbn;
		this.book_name = book_name;
		this.book_author = book_author;
	...
	public String toString() {
		...
		builder.append("OrderItem [itemId=").append(itemId).append(", book_isbn=").append(book_isbn)
				...
				.append(", count=").append(count).append(", allPrice=").append(allPrice).append(", order=")
				.append(order).append("]");
