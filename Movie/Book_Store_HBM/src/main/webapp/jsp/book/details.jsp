...
<html>
	...
	<!--外层div-->
			...
			<div class="col-md-8 col-sm-12">
				...
				<div class="row">
					<div class="col-sm-12 col-md-6">
						<div class="thumbnail">
							<a><img src="images/${book.imgurl}" style="height: 200px;" alt="通用的占位符缩略图"></a>
							<div class="caption">
								<h3>${book.name}</h3>
					...
					<div class="col-sm-12 col-md-6">
						<div class="thumbnail">
							<ul class="list-group">
								...
								<li class="list-group-item"><span class="text-info" style="text-decoration: line-through;">原价:$ ${b.oldPrice}</span><span style="text-decoration: line-through;"></span></li>
				...
				<div>
					...
					<div class="row" id="love">
						<div class="col-sm-12 col-md-12 wow fadeInRight animated">
							<div class="thumbnail">
								<a href="${path}/list/book"><img src="images/${book.imgurl}" style="height: 200px; " alt="通用的占位符缩略图 "></a>
								<div class="caption ">
									<h3>${book.name}</h3>
								</div>
							</div>
		...
		<script src="${path}/s/wow.js"></script>
